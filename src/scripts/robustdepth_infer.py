...
from src.inference_wrapper.robustdepth.robustdepth_pipeline import robustdepthEstimator
...
args.add_argument('--encoder', default='vit', type=str, help='encoder type for robustdepth model. Choices: "vit", "resnet". Default "vit".',
                   choices=['vit', 'resnet'])
...
if __name__ == "__main__":
    ...
    robustdepth_model = robustdepthEstimator(
