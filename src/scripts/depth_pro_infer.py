from src.inference_wrapper.depth_pro_api.depth_pro_dataset import HYPERSIM, KITTI, NYUD
...
from src.inference_wrapper.depth_pro_api.depth_pro_pipeline import DepthProEstimator
...
if __name__ == "__main__":
    ...
    depth_pro_model = DepthProEstimator(
    ...
    for i, batch in data_iter:
        ...
        with torch.no_grad():
            ...
            depth_pred_original = depth_pro_model.infer(img)  # depth_pred_original: 1, C, W
            ...
            if max_batch_num > 1 and args.optimize_method in ["original_direct", "pareto_direct"] and inf_pos[0] >= 0 and inf_pos[1] > 1:
                ...
                depth_pred = depth_pro_model.batch_infer(input_image)[position:position+1, :]
            else:
                depth_pred = depth_pro_model.batch_infer(input_image)
