# ablation study for max iterations
cuda_device=1
...
seed=42
max_batch_num_list=(1 4 8 10 16)
reduced_bit_depth=5
kernel_size=7
...
for perturb_type in ${perturb_list[@]}; do
    ...
    for max_batch_num in ${max_batch_num_list[@]}; do
        root_save_dir="/path/to/experiment_results/ablation_study/max_batch_num/max_batch_num_${max_batch_num}/${perturb_type}/"
